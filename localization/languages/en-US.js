module.exports = {
  ...
  translations: {
    ...
    focusModeExplanation1:
      "In focus mode, you can't create new tabs or switch tasks.",
    focusModeExplanation2:
      'You can leave focus mode by unchecking "focus mode" in the view menu.',
    /* relative dates */
    ...
    sslTimeErrorMessage:
      "Min couldn't connect securely to this website. Please make sure your computer's clock is set correctly.",
    ...
    multipleInstancesErrorMessage:
      "An error occurred. Please close any other open instances and restart Min.",
    /* pages/sessionRestoreError/index.html */
    sessionRestoreErrorTitle: "An error occurred",
    sessionRestoreErrorExplanation:
      "Your saved tabs couldn't be restored correctly.",
    sessionRestoreErrorBackupInfo:
      "We've saved a backup of your data at this location: %l.", //%l will be replaced with a path to a file
    sessionRestoreErrorLinkInfo: {
      unsafeHTML:
        'If this error continues to occur, please open a new issue <a href="https://github.com/minbrowser/min" target="_blank">here</a>.',
    },
    ...
    settingsContentBlockingExceptions:
      "Ads will still be allowed on these websites:",
    settingsBlockScriptsToggle: "Block scripts",
    settingsBlockImagesToggle: "Block images",
    settingsBlockedRequestCount:
      "So far, Min has blocked <strong>{{blockedCount}}</strong> ads and trackers.",
    ...
    settingsUserscriptsExplanation: 'User scripts allow you to modify the behavior of websites - <a href="https://github.com/minbrowser/min/wiki/userscripts">learn more</a>.',
    ...
    settingsDDGExplanation:
      "Set DuckDuckGo as the default search engine to see instant answers in the searchbar.",
    ...
    /* PDF Viewer */
    "PDFPageCounter/page": "page",
    "PDFPageCounter/of": "of",
    PDFPageCounter: {
    ...
    autoRedirectBannerReader:
      "Always open articles from this site in reader view?",
    ...
    /* Autofill settings */
    settingsPasswordAutoFillHeadline: "Password",
    settingsSelectPasswordManager:
      "Choose one of the supported password managers:",
    ...
    passwordManagerSetupStep1: {
      unsafeHTML:
        "First, <a id='password-manager-setup-link'></a> and extract it for your system.",
    },
    passwordManagerInstallerSetup: {
      unsafeHTML:
        "Download <a id='password-manager-setup-link-installer'></a> and drag the file into the box below:",
    },
    ...
    passwordManagerBitwardenSignIn:
      'To connect your Bitwarden account, go to vault.bitwarden.com/#/settings/account, scroll to the bottom, and choose "View API Key". Then paste the values into the fields below.',
    passwordManagerSetupSignIn:
      "Sign in to your password manager to start using autofill. Your credentials won't be stored anywhere inside Min.",
    ...
    passwordManagerSetupRetry:
      "Make sure you're using the right file and entering a correct password. You can retry by dragging the tool here again.",
    passwordManagerUnlock:
      "Enter your %p master password to unlock the password store:",
    /* Password save bar */
