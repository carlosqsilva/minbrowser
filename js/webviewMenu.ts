  ...
  public showMenu(data, extraData) {
    ...
    if (link) {
      ...
      linkActions.push({
        ...
        click: () => {
          browserUI.addTab(tasks.tabs.add({ url: link, private: true }), {
            enterEditMode: false,
            openInBackground: openInBackground,
          });
        },
      ...
      imageActions.push({
        label: l("viewImage"),
        click: () => {
          webviews.update(tasks.tabs.getSelected(), mediaURL);
        },
      });
      ...
      if (!currentTab.private) {
        imageActions.push({
          ...
          click: () => {
            browserUI.addTab(tasks.tabs.add({ url: mediaURL }), {
              enterEditMode: false,
              openInBackground: openInBackground,
            });
          },
      ...
      imageActions.push({
        ...
        click: () => {
          browserUI.addTab(tasks.tabs.add({ url: mediaURL, private: true }), {
            enterEditMode: false,
            openInBackground: openInBackground,
          });
        },
