...
// import { currentTab, stateUI } from "../state";

// export const BookmarkStartButton = () => {
//   const [isBookmarked, setBookmarker] = createSignal(false);

//   createEffect(() => {
//     if (!stateUI.editorHidden) {
//       places.getItem(currentTab()?.url, (item) => {
//         setBookmarker(item && item.isBookmarked);
//       });
//     }
//   });
...
//   return (
//     <button
//       hidden={!currentTab()?.url}
//       title={l("addBookmark")}
//       aria-label={l("addBookmark")}
//       class="tab-editor-button bookmarks-button i"
//       aria-pressed={isBookmarked()}
//       classList={{
//         ["carbon:star"]: !isBookmarked(),
//         ["carbon:star-filled"]: isBookmarked(),
//       }}
//     />
//   );
// };
