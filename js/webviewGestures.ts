...
let swipeGestureTimeout: NodeJS.Timeout;
let swipeGestureLowVelocityTimeout: NodeJS.Timeout;
let swipeGestureDelay = 100; // delay before gesture is complete
let swipeGestureVelocityDelay = 70; // the time (in ms) that can elapse without a minimum amount of movement before the gesture is considered almost completed
...
let webviewMinZoom = 0.5;
let webviewMaxZoom = 3.0;
